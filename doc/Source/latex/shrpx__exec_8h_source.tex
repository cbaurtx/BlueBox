\doxysection{shrpx\+\_\+exec.\+h}
\hypertarget{shrpx__exec_8h_source}{}\label{shrpx__exec_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_exec.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_exec.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ SHRPX\_EXEC\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ SHRPX\_EXEC\_H}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#include\ "{}unistd.h"{}}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keyword}{namespace\ }shrpx\ \{}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structshrpx_1_1Process}{Process}}\ \{}
\DoxyCodeLine{00033\ \ \ pid\_t\ pid;}
\DoxyCodeLine{00034\ \ \ \textcolor{comment}{//\ fd\ to\ read\ from\ process}}
\DoxyCodeLine{00035\ \ \ \textcolor{keywordtype}{int}\ rfd;}
\DoxyCodeLine{00036\ \};}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{comment}{//\ Executes\ command\ |argv|\ after\ forking\ current\ process.\ \ The\ command}}
\DoxyCodeLine{00039\ \textcolor{comment}{//\ should\ not\ expect\ to\ read\ from\ stdin.\ \ Parent\ process\ can\ read\ the}}
\DoxyCodeLine{00040\ \textcolor{comment}{//\ stdout\ from\ command\ using\ proc.rfd.\ \ On\ success,\ this\ function}}
\DoxyCodeLine{00041\ \textcolor{comment}{//\ returns\ 0,\ and\ process\ information\ is\ stored\ in\ |proc|.\ \ Otherwise,}}
\DoxyCodeLine{00042\ \textcolor{comment}{//\ returns\ -\/1.}}
\DoxyCodeLine{00043\ \textcolor{keywordtype}{int}\ exec\_read\_command(\mbox{\hyperlink{structshrpx_1_1Process}{Process}}\ \&proc,\ \textcolor{keywordtype}{char}\ *\textcolor{keyword}{const}\ argv[]);}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \}\ \textcolor{comment}{//\ namespace\ shrpx}}
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00047\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SHRPX\_EXEC\_H}}
