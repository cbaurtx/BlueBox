\doxysection{shrpx\+\_\+mruby\+\_\+module.\+h}
\hypertarget{shrpx__mruby__module_8h_source}{}\label{shrpx__mruby__module_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_mruby\_module.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_mruby\_module.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ SHRPX\_MRUBY\_MODULE\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ SHRPX\_MRUBY\_MODULE\_H}}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#include\ "{}http2.h"{}}}
\DoxyCodeLine{00033\ }
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{keyword}{namespace\ }mruby\ \{}
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ mrb\_value\ init\_module(mrb\_state\ *mrb);}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{keywordtype}{void}\ delete\_downstream\_from\_module(mrb\_state\ *mrb,\ Downstream\ *downstream);}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ mrb\_value\ create\_headers\_hash(mrb\_state\ *mrb,\ \textcolor{keyword}{const}\ HeaderRefs\ \&headers);}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \}\ \textcolor{comment}{//\ namespace\ mruby}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \}\ \textcolor{comment}{//\ namespace\ shrpx}}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00052\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SHRPX\_MRUBY\_MODULE\_H}}
