\doxysection{shrpx\+\_\+downstream\+\_\+test.\+h}
\hypertarget{shrpx__downstream__test_8h_source}{}\label{shrpx__downstream__test_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_downstream\_test.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_downstream\_test.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ SHRPX\_DOWNSTREAM\_TEST\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ SHRPX\_DOWNSTREAM\_TEST\_H}}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ MunitSuite\ downstream\_suite;}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ munit\_void\_test\_decl(test\_downstream\_field\_store\_append\_last\_header)}
\DoxyCodeLine{00041\ munit\_void\_test\_decl(test\_downstream\_field\_store\_header)}
\DoxyCodeLine{00042\ munit\_void\_test\_decl(test\_downstream\_crumble\_request\_cookie)}
\DoxyCodeLine{00043\ munit\_void\_test\_decl(test\_downstream\_assemble\_request\_cookie)}
\DoxyCodeLine{00044\ munit\_void\_test\_decl(test\_downstream\_rewrite\_location\_response\_header)}
\DoxyCodeLine{00045\ munit\_void\_test\_decl(test\_downstream\_supports\_non\_final\_response)}
\DoxyCodeLine{00046\ munit\_void\_test\_decl(test\_downstream\_find\_affinity\_cookie)}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \}\ \textcolor{comment}{//\ namespace\ shrpx}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SHRPX\_DOWNSTREAM\_TEST\_H}}
