\doxysection{quic.\+h}
\hypertarget{quic_8h_source}{}\label{quic_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/quic.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/quic.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ QUIC\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ QUIC\_H}}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{keyword}{namespace\ }quic\ \{}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{keyword}{enum\ class}\ ErrorType\ \{}
\DoxyCodeLine{00035\ \ \ Transport,}
\DoxyCodeLine{00036\ \ \ TransportVersionNegotiation,}
\DoxyCodeLine{00037\ \ \ TransportIdleTimeout,}
\DoxyCodeLine{00038\ \ \ Application,}
\DoxyCodeLine{00039\ \};}
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{keyword}{struct\ }Error\ \{}
\DoxyCodeLine{00042\ \ \ Error(ErrorType\ type,\ uint64\_t\ code)\ :\ type(type),\ code(code)\ \{\}}
\DoxyCodeLine{00043\ \ \ Error()\ :\ type(ErrorType::Transport),\ code(0)\ \{\}}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \ \ ErrorType\ type;}
\DoxyCodeLine{00046\ \ \ uint64\_t\ code;}
\DoxyCodeLine{00047\ \};}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \mbox{\hyperlink{structquic_1_1Error}{Error}}\ err\_transport(\textcolor{keywordtype}{int}\ liberr);}
\DoxyCodeLine{00050\ \mbox{\hyperlink{structquic_1_1Error}{Error}}\ err\_transport\_idle\_timeout();}
\DoxyCodeLine{00051\ \mbox{\hyperlink{structquic_1_1Error}{Error}}\ err\_transport\_tls(\textcolor{keywordtype}{int}\ alert);}
\DoxyCodeLine{00052\ \mbox{\hyperlink{structquic_1_1Error}{Error}}\ err\_application(\textcolor{keywordtype}{int}\ liberr);}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ \}\ \textcolor{comment}{//\ namespace\ quic}}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ QUIC\_H}}
