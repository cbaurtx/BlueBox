\doxysection{managed\+\_\+components/espressif\+\_\+\+\_\+esp-\/dsp/examples/applications/lyrat\+\_\+board\+\_\+app Directory Reference}
\hypertarget{dir_d164ba013b7577acba82d364c8c61096}{}\label{dir_d164ba013b7577acba82d364c8c61096}\index{managed\_components/espressif\_\_esp-\/dsp/examples/applications/lyrat\_board\_app Directory Reference@{managed\_components/espressif\_\_esp-\/dsp/examples/applications/lyrat\_board\_app Directory Reference}}
Directory dependency graph for lyrat\+\_\+board\+\_\+app\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=269pt]{dir_d164ba013b7577acba82d364c8c61096_dep}
\end{center}
\end{figure}
...
\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md89}{}\doxysubsection{\texorpdfstring{ESP-\/\+DSP LyraT Board audio processing application}{ESP-\/\+DSP LyraT Board audio processing application}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md89}
...
To control the volume/bass/treble, please select the value by press \textquotesingle{}Set\textquotesingle{} button and adjust the value by \textquotesingle{}+/-\/\textquotesingle{} buttons.\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md90}{}\doxysubsection{\texorpdfstring{The Triple Audio Buffer}{The Triple Audio Buffer}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md90}
...
Triple buffering is particularly useful when working with real-\/time audio processing applications, where low latency and uninterrupted playback are crucial.\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md91}{}\doxysubsection{\texorpdfstring{Audio Processing Flow}{Audio Processing Flow}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md91}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md92}{}\doxysubsection{\texorpdfstring{How to use the example}{How to use the example}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md92}
\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md93}{}\doxysubsubsection{\texorpdfstring{Hardware required}{Hardware required}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md93}
This example require LyraT development board.\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md94}{}\doxysubsubsection{\texorpdfstring{Configure the project}{Configure the project}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md94}
Under Component Config -\/-\/-\/\texorpdfstring{$>$}{>} DSP Library -\/-\/-\/\texorpdfstring{$>$}{>} DSP Optimization, it\textquotesingle{}s possible to choose either the optimized or ANSI implementation, to compare them.\hypertarget{dir_d164ba013b7577acba82d364c8c61096_autotoc_md95}{}\doxysubsubsection{\texorpdfstring{Build and flash}{Build and flash}}\label{dir_d164ba013b7577acba82d364c8c61096_autotoc_md95}
