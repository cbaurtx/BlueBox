\doxysection{shrpx\+\_\+quic\+\_\+listener.\+h}
\hypertarget{shrpx__quic__listener_8h_source}{}\label{shrpx__quic__listener_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_quic\_listener.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_quic\_listener.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ SHRPX\_QUIC\_LISTENER\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ SHRPX\_QUIC\_LISTENER\_H}}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structshrpx_1_1UpstreamAddr}{UpstreamAddr}};}
\DoxyCodeLine{00035\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classshrpx_1_1Worker}{Worker}};}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{keyword}{class\ }QUICListener\ \{}
\DoxyCodeLine{00038\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00039\ \ \ QUICListener(\textcolor{keyword}{const}\ \mbox{\hyperlink{structshrpx_1_1UpstreamAddr}{UpstreamAddr}}\ *faddr,\ \mbox{\hyperlink{classshrpx_1_1Worker}{Worker}}\ *worker);}
\DoxyCodeLine{00040\ \ \ \string~QUICListener();}
\DoxyCodeLine{00041\ \ \ \textcolor{keywordtype}{void}\ on\_read();}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00044\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structshrpx_1_1UpstreamAddr}{UpstreamAddr}}\ *faddr\_;}
\DoxyCodeLine{00045\ \ \ \mbox{\hyperlink{classshrpx_1_1Worker}{Worker}}\ *worker\_;}
\DoxyCodeLine{00046\ \ \ ev\_io\ rev\_;}
\DoxyCodeLine{00047\ \};}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \}\ \textcolor{comment}{//\ namespace\ shrpx}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SHRPX\_QUIC\_LISTENER\_H}}
