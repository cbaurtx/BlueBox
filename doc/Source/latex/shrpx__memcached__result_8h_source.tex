\doxysection{shrpx\+\_\+memcached\+\_\+result.\+h}
\hypertarget{shrpx__memcached__result_8h_source}{}\label{shrpx__memcached__result_8h_source}\index{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_memcached\_result.h@{managed\_components/espressif\_\_nghttp/nghttp2/src/shrpx\_memcached\_result.h}}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ SHRPX\_MEMCACHED\_RESULT\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ SHRPX\_MEMCACHED\_RESULT\_H}}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{keyword}{enum\ class}\ MemcachedStatusCode\ :\ uint16\_t\ \{}
\DoxyCodeLine{00035\ \ \ NO\_ERROR,}
\DoxyCodeLine{00036\ \ \ EXT\_NETWORK\_ERROR\ =\ 0x1001,}
\DoxyCodeLine{00037\ \};}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{keyword}{struct\ }MemcachedResult\ \{}
\DoxyCodeLine{00040\ \ \ MemcachedResult(MemcachedStatusCode\ status\_code)\ :\ status\_code(status\_code)\ \{\}}
\DoxyCodeLine{00041\ \ \ MemcachedResult(MemcachedStatusCode\ status\_code,\ std::vector<uint8\_t>\ value)}
\DoxyCodeLine{00042\ \ \ \ \ :\ value(std::move(value)),\ status\_code(status\_code)\ \{\}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \ \ std::vector<uint8\_t>\ value;}
\DoxyCodeLine{00045\ \ \ MemcachedStatusCode\ status\_code;}
\DoxyCodeLine{00046\ \};}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \}\ \textcolor{comment}{//\ namespace\ shrpx}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SHRPX\_MEMCACHED\_RESULT\_H}}
